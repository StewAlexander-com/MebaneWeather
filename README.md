...
- [MebaneWeather.com - Enhanced Severe Weather Dashboard](#-mebaneweathercom---enhanced-severe-weather-dashboard)
...
2. Set coordinates and NWS/SPC values for your location:
   ...
   | `SPC_OUTLOOK_URL`  | SPC Day 1 convective outlook                 | `https://www.spc.noaa.gov/products/outlook/day1otlk.html`                        |
   | `NWS_OFFICE`       | NWS office for AFD and "From the NWS:" link  | `'RAH'` (Raleigh)                                                                |

3. Build your NWS URL: visit `https://forecast.weather.gov/MapClick.php`, click your location, then copy the URL containing `lat=` and `lon=`.
...
**Project Stats:** Created June 2025 • Last major update March 2025 • Location: Mebane, NC (Alamance County, Zone NCZ023) • NWS Office: Raleigh, NC (RAH) • Maintainer: [@StewAlexander-com](https://github.com/StewAlexander-com)
